...
def GetInfoProfile():
        with open('/sdcard/CyberRow-X/SUCCESS-OK-ID.txt', 'r') as file:
...
ll=str([hari,tanggal])
kk=str([xy,co])
hx=(f"""  [bold green1]TODAY DATE[medium_purple1]  ⟩ [bold green1]{ll}
...
def main() -> None:
    ...
    num_accounts = int(input("\033[1;37mHOW MANY ACCOUNT : "))
