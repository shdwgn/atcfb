...
domain_groups = {
    'common': ['exdonuts.com','fuwari.be','fuwamofu.com','merry.pink','simaenaga.com']
}
...
def banner(): 
    clear_screen()
    print(f"""\033[1;37m╔═══════════════════════════════╗╔═══════════════════════════╗
\033[1;37m║\033[1;36m╔═╗╦ ╦╔╦╗╔═╗  ╔═╗╔╗   ╦═╗╔═╗╔═╗\033[1;37m║║ONWER : \033[1;32mBRYX && ARAFAT    \033[1;37m ║
\033[1;37m║\033[1;36m╠═╣║ ║ ║ ║ ║  ╠╣ ╠╩╗  ╠╦╝║╣ ║ ╦\033[1;37m║║STATUS: \033[1;32mFREE \033[1;37mOR \033[1;32mACTIVE\033[1;37m     ║
\033[1;37m║\033[1;36m╩ ╩╚═╝ ╩ ╚═╝  ╚  ╚═╝  ╩╚═╚═╝╚═╝\033[1;37m║║VERSION: 0.6 \033[1;31mTESTING\033[1;37m       ║
\033[1;37m╚═══════════════════════════════╝╚═══════════════════════════╝""")
...
def createfb():
    ...
    banner()
    print(f"""\033[1;37m╔═══════════════════════════════════╗
\033[1;37m║\033[1;32m1 NAME PHILIPPINES 2 NAMA INDONESIA\033[1;37m║
\033[1;37m╚═══════════════════════════════════╝""")
    name = input(f"CHOOSE NAME : ")
    print(f"""\033[1;37m╔════════════════════════════════════╗
\033[1;37m║\033[1;32mEXAMPLE: 100,200,300,400,500,600,700\033[1;37m║
\033[1;37m╚════════════════════════════════════╝""")
    num = int(input("HOW MANY ACCOUNT : "))
    print(f"""\033[1;37m╔════════════════════════════════════╗
\033[1;37m║\033[1;32m1 DEFAULT PASSWORD 2 CUSTOM PASSWORD\033[1;37m║
\033[1;37m╚════════════════════════════════════╝""")
    password = input(f"CHOOSE PASSWORD : ")
    if password == '2':
        pww = input("ENTER CUSTOM PASSWORD : ")
    banner()
    print(f"""\033[1;37m╔═════════════════════════════════════╗
\033[1;37m║\033[1;37mTOTAL ACCOUNTS : \033[1;32m{num}\033[1;37m                 ║
\033[1;37m║\033[1;37mPROCESSING PLEASE WAIT...\033[1;37m            ║
\033[1;37m║\033[1;37mUSE FLIGHT MODE AFTER EVERY \033[1;31m5 \033[1;37mMINUTES\033[1;37m║
\033[1;37m╚═════════════════════════════════════╝""")
    for make in range(num):
        try:
            sys.stdout.write(f"\r\033[1;37m✅ \033[1;32mOK : {len(oks)} \033[1;37m| \033[1;37m❌ \033[1;31mCP : {len(cps)}\033[1;37m")
            sys.stdout.flush()
            ...
            reg_submit = ses.post(reg_url, data=payload, headers=headers, proxies=proxy)
            if "c_user" in ses.cookies.get_dict():
                ids = ses.cookies.get_dict()["c_user"]
                cookie = ";".join([f"{key}={val}" for key, val in ses.cookies.get_dict().items()])
                print(f'\r\r\033[1;32m[ACTIVE💙] {firstname} {lastname} | {ids} | {pww}\033[1;97m')
                print(f'\033[1;32m[COOKIE🍪] : {cookie}\033[1;97m')
