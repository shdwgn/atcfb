...
# Configuration
CONFIG = {
    "output_dir": os.path.expanduser("~/XIYAD") if platform.system().lower() != 'android' else "/sdcard/XIYAD",
...
"Drew", "Elijah", "Elena", "Eliana", "Elias", "Elise", "Eliza", "Emanuel", "Emerson", "Emily",
"Enrique", "Erin", "Estella", "Ethan", "Eve", "Ezekiel", "Faith", "Felipe", "Fiona", "Francis",
"Francesca", "Gabriel", "Gabriella", "Gael", "Gianna", "Gilbert", "Giselle", "Gregorio", "Gwen", "Hannah",
"Haron", "Hazel", "Heidi", "Hendrick", "Hillary", "Hiro", "Honey", "Ian", "Ibrahim", "Ivy",
"Iñigo", "Isaac", "Isabella", "Isla", "Ivan", "Jade", "Jake", "James", "Jane", "Janella",
"Javier", "Jazmin", "Jed", "Jessa", "Jethro", "Jillian", "Joaquin", "Jocelyn", "Johan", "Johanna",
...
"Barela", "Bariuan", "Baron", "Barredo", "Barrios", "Bartolome", "Basco", "Bautista", "Bayani", "Baylon",
"Belen", "Belisario", "Benitez", "Bercasio", "Bernardo", "Beso", "Bibat", "Bienvenido", "Bigornia", "Bilbao",
"Bituin", "Blanco", "Bocalan", "Bodiongan", "Bolano", "Bonifacio", "Borja", "Bordallo", "Borromeo", "Braga",
"Brillantes", "Buenaflor", "Buenaventura", "Bugayong", "Bulatao", "Bundoc", "Burgos", "Butron", "Cabal", "Caballes",
"Cabarles", "Cabardo", "Cabrera", "Cabusao", "Cacnio", "Cagulada", "Cajanding", "Calderon", "Calimag", "Calipusan",
"Callangan", "Calo", "Camacho", "Camba", "Campos", "Canlas", "Cañete", "Caoile", "Capistrano", "Caraig",
"Carillo", "Carmona", "Carreon", "Carpio", "Carvajal", "Casas", "Casiano", "Castañeda", "Castro", "Catacutan",
"Cauilan", "Cavinta", "Ceballos", "Celedonio", "Centeno", "Cervantes", "Chavez", "Chua", "Clemente", "Cordero",
"Coronel", "Cortez", "Cruz", "Cuadra", "Cueto", "Cunanan", "Dacanay", "Dacumos", "Dado", "Dagohoy",
"Dagul", "Dahilig", "Dajao", "Dalisay", "Damasco", "Danao", "Dangcalan", "Dante", "Dela Cruz", "Dela Paz",
"Dela Rosa", "Delos Reyes", "Dela Vega", "Dela Torre", "Delfin", "Dizon", "Domingo", "Dumlao", "Duran", "Duya",
"Ebora", "Edralin", "Eguia", "Elduayan", "Elepaño", "Elizalde", "Enero", "Enriquez", "Escalante", "Escobar",
...
"Ronquillo", "Rosales", "Rosario", "Rosel", "Rubio", "Rueda", "Ruiz", "Sabado", "Sablan", "Sala",
"Salazar", "Salcedo", "Salvador", "Samonte", "Sanchez", "Sandoval", "Santos", "Sarmiento", "Sebastian", "Sevilla",
"Silva", "Simbulan", "Singson", "Sison", "Soliven", "Sotto", "Suarez", "Sumulong", "Sunga", "Suñer",
"Tadena", "Tagle", "Talavera", "Tamayo", "Tanchanco", "Tanedo", "Tantoco", "Tanyag", "Tapia", "Tiburcio",
"Tiglao", "Tolentino", "Torres", "Tungol", "Tupas", "Valdez", "Valencia", "Valenzuela", "Villar",
"Villanueva", "Villareal", "Villasenor", "Vinarao", "Vizcarra", "Yumul", "Zabala", "Zamora", "Zaragoza" ]
...
def createfb_method_1():
    ...
    pww = get_pass() if password_choice == '1' else input(f"{W}[{G}•{W}]{G} ENTER PASSWORD {W}:{G} ")
    linex()
    # New prompt for showing details
    show_details = input(f"{W}[{G}•{W}]{G} Show All Details y{R}/{G}n {W}:{G} ").lower()
    banner()
    print(f"{W}[{G}•{W}]{G} ACCOUNT CREATING STARTED")
    print(f'{W}[{G}•{W}]{G} TOTAL ID {W}: {R}{num}{W}')
    ...
    for _ in range(num):
        try:
            sys.stdout.write(f"\r{W}EX XD{G} OK • {len(oks)}{W} ")
            sys.stdout.flush()
            ses = requests.Session()
            response = ses.get("https://x.facebook.com/reg")
            form = extractor(response.text)
...
def set_default_password():
    try:
        ...
        file_path = os.path.expanduser("/sdcard/XIYAD/2FA/default_password.txt")
